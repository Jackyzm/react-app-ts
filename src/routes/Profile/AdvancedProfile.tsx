...
<Badge status="default" text={`${<span style={{ color: 'rgba(0, 0, 0, 0.45)' }}>未响应</span>}`} />
        ...
        <div className={'textSecondary'} style={{ marginTop: 4 }}>
            耗时：2小时25分钟
    </div>
    </div>
);
...
export default class AdvancedProfile extends Component<{profile, loading: boolean, getList:()=>void, clearList:()=>void }, {operationkey: string, stepDirection: string}> {
    ...
    public render() {
        const { stepDirection } = this.state;
        const { profile={advancedOperation1:[], advancedOperation2:[], advancedOperation3:[]}, loading } = this.props;
        ...
        return (
            ...
            >
                <Card title="流程进度" style={{ marginBottom: 24 }} bordered={false}>
                    <Steps direction={stepDirection as "horizontal" | "vertical"} progressDot={customDot} current={1}>
