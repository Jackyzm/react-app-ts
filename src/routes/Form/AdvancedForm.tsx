...
class AdvancedForm extends React.Component<{form:any, submitting: boolean}, {width: string}> {
    constructor(props) {
        super(props)
        this.state={
            width: '100%',
    ...
    private resizeFooterToolbar = () => {
        const siders = document.querySelectorAll('.ant-layout-sider') as NodeListOf<HTMLElement>;
        const width = `calc(100% - ${siders[0].style.width})`;
