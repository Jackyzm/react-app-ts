...
const routeMap = [
    { name: '登录', path: `${PARENT_URL}/login`, component: Login },
    { name: '注册', path: `${PARENT_URL}/register`, component: Register },
    { name: '注册结果', path: `${PARENT_URL}/register-result`, component: RegisterResult },
]
